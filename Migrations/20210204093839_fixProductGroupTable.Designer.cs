...
namespace SmileShop_API_V1.Migrations
{
    ...
    [Migration("20210204093839_fixProductGroupTable")]
    partial class fixProductGroupTable
    {
            ...
            modelBuilder.Entity("SmileShop_API_V1.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7d8186ef-99df-4b78-8b45-11aab28a5e3b"),
                            Name = "user"
                        },
                        new
                        {
                            Id = new Guid("48457f46-8481-46a8-a910-536e99c6f281"),
                            Name = "Manager"
                        },
                        new
                        {
                            Id = new Guid("b62abee8-b456-4cde-bf10-d8e097804d1b"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("1a14a4ba-d7d7-4fdf-a827-7267b40736fe"),
                            Name = "Developer"
                        });
                });
