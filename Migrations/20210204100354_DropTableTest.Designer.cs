...
namespace SmileShop_API_V1.Migrations
{
    ...
    [Migration("20210204100354_DropTableTest")]
            ...
            modelBuilder.Entity("SmileShop_API_V1.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("534117a2-54ef-4b50-a642-8ceca526cdd5"),
                            Name = "user"
                        },
                        new
                        {
                            Id = new Guid("fd02be6c-1bf3-4430-b8cc-b2cff5d8568e"),
                            Name = "Manager"
                        },
                        new
                        {
                            Id = new Guid("5deea541-1db0-4b29-bf75-8bef1c8f8548"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("05e04941-8dc4-43a6-8338-c19a3aab2571"),
                            Name = "Developer"
                        });
                });
